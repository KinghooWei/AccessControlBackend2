...
class FaceUtils(object):
    ...
    def __resize(self, factor=0.8):
        """ 附属品重塑大小 """
        img = Image.open(self.__cover_picture).convert("RGBA")
...
if __name__ == '__main__':
    os.chdir('E:/IDEAProjects/demo/src/main/resources/facialMask')
    # FaceUtils.transparent_back('背景非透明.png')   1.先背景透明化
    original_picture_url = "faceWithoutMask.jpg"  # 2. 原图
    cover_picture_url = "glasses.png"  # 3. 背景透明化的附属图片
    #cover_picture_url = Image.open("images/mao.jpg").convert("RGBA")
